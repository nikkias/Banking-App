...
public class DemoDataInitializer {
    ...
    CommandLineRunner demoData(BankService bankService) {
        return args -> {
            ...
            Customer anna = bankService.registerCustomer("employee", "Anna", "Muster", "anna");
            Customer maxim = bankService.registerCustomer("employee", "Maxim", "Schneider", "maxim");
            Customer clara = bankService.registerCustomer("employee", "Clara", "Berger", "clara");
