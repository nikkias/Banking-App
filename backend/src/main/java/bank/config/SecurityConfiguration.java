...
public class SecurityConfiguration {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .headers(headers -> headers
                ...
                .permissionsPolicyHeader(permissions -> permissions.policy("camera=(), geolocation=(), microphone=(), payment=()")))
    ...
    UserDetailsService userDetailsService(PasswordEncoder passwordEncoder) {
        return new InMemoryUserDetailsManager(
                ...
                User.withUsername("anna").password(passwordEncoder.encode("anna123")).roles("CUSTOMER").build(),
                User.withUsername("maxim").password(passwordEncoder.encode("maxim123")).roles("CUSTOMER").build(),
                User.withUsername("clara").password(passwordEncoder.encode("clara123")).roles("CUSTOMER").build(),
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(List.of("Authorization", "Content-Type", CorrelationIdFilter.HEADER_NAME));
